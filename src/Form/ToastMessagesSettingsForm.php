...
/**
 * Defines a form that configures toast message settings.
 */
class ToastMessagesSettingsForm extends ConfigFormBase {
   ...
   * @var string
   */
  const SETTINGS = 'toast_messages.settings';

  /**
   * {@inheritdoc}
   */
  public function getFormId(): string {
    return 'toast_messages_settings';
  }
  ...
  protected function getEditableConfigNames(): array {
    return ['toast_messages.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    ...
    $form['toast_messages_size'] = [
      '#type' => 'horizontal_tabs',
      '#tree' => TRUE,
      '#prefix' => '<div id="toast_messages_tabs">',
      '#suffix' => '</div>',
    ];

    $form['toast_messages_basic'] = [
      '#type' => 'details',
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    $config = $this->configFactory()->getEditable('toast_messages.settings');
   ...
   */
  public function getInAnimationOptions(): array {
    return [
   ...
   *   options for animation toast.
   */
  public function getOutAnimationOptions(): array {
    return [
      'fadeOut' => 'fadeOut',
   ...
   */
  public function getPotitionOptions(): array {
    return [
